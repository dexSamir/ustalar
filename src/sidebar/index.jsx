...
const Sidebar = () => {
  const menu = [
    ...
    { label: "Çıxış", path: "logout", icon: <MdLogout size={20} /> },
  ];
  ...
  return (
    <>
      {!isSidebarOpen && (
        <i onClick={() => setIsSidebarOpen(true)} className="fa-solid fa-bars cursor-pointer text-blue-600"></i>
      )}
      ...
      >
        <div className="flex w-full justify-between items-center relative">
            ...
            {isSidebarOpen && <i onClick={() => setIsSidebarOpen(false)} className="fa-solid fa-xmark text-white cursor-pointer"></i>}
        </div>
